  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Link 
          href="/admin/blog/new"
          className="flex items-center gap-2 bg-cyan-600 hover:bg-cyan-500 text-white px-4 py-2 rounded-xl font-bold transition-all"
        >
          <PlusCircle size={18} />
          Create Post
        </Link>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <Link 
                        ...
                        className="p-1.5 text-zinc-500 hover:text-cyan-400 hover:bg-cyan-400/5 rounded-lg transition-all"
                        title="Edit"
                      >
                        <Edit3 size={16} />
                      </Link>
