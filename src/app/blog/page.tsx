...
export const metadata = createSeoMetadata({
  ...
  ogTitle: "Codyn Engineering Insights",
      ...
      <div className="border-b border-white/5 bg-[#09090b]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-6 items-center">
            ...
            <Link href="https://github.com/DEVAANSH001/Codyn" target="_blank" className="text-sm text-zinc-400 hover:text-white transition-colors">GitHub</Link>
          </div>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mb-16">
          <h1 className="text-5xl font-extrabold mb-4 tracking-tight">
            Engineering <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Insights</span>
          </h1>
                    ...
                    <div className="bg-zinc-900/40 backdrop-blur-xl p-1 md:p-2">
                      <div className="grid md:grid-cols-2 gap-8 items-center p-6 md:p-8">
                        ...
                        <div>
                          ...
                          <h2 className="text-3xl font-bold mb-4 group-hover:text-cyan-400 transition-colors">
                            {featuredPost.title}
                          </h2>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center text-[10px] font-bold">
                                RM
                              </div>
