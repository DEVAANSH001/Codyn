    ...
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mt-20 pt-12 border-t border-white/5 text-center">
            <h4 className="text-sm font-bold uppercase tracking-[0.2em] text-cyan-400 mb-8">Ready to see it in action?</h4>
            <Link 
                href="/" 
                className="inline-block bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold px-8 py-4 rounded-2xl hover:opacity-90 transition-opacity shadow-lg shadow-cyan-500/20"
            >
