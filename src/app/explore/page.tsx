...
export const metadata: Metadata = createSeoMetadata({
  ...
  description:
    "Explore live Codyn pages for GitHub code analysis, AI code review, repository risk analysis, and security workflow comparisons.",
  canonical: "/explore",
  keywords: [
...
export const livePages: TopicEntry[] = [
  ...
  },
  {
    ...
    summary: "Understand where SonarQube and Codyn are complementary.",
    category: "Comparison",
  },
  {
    title: "Codyn vs Snyk",
...
const faqItems = [
  {
    ...
    answer:
      "Explore is the navigation hub for Codyn analysis, security, and comparison guides so teams can find the right workflow quickly.",
  },
  {
  ...
  {
    question: "Where should I start if I am new to Codyn?",
    answer:
...
const itemListSchema = buildItemListStructuredData({
  name: "Codyn Live Workflow Pages",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mb-10">
          ...
          <p className="text-zinc-300 text-lg mb-4 max-w-5xl leading-relaxed">
            Explore is your fastest route to the full Codyn content hub for repository analysis,
