...
export const metadata: Metadata = createSeoMetadata({
    title: "FAQ",
    description: "Frequently asked questions about Codyn's Agentic CAG, GitHub repository analysis, architecture visualization, and security scanning.",
    canonical: "/faq",
    ogImage: buildOgImageUrl("marketing", { variant: "faq" }),
    ogTitle: "Codyn FAQ",
    ogDescription: "Frequently asked questions about Codyn's repository analysis and security scanning.",
});
    ...
    return (
        <main className="min-h-screen max-w-4xl mx-auto py-24 px-6">
            ...
            <div className="mb-12">
                ...
                <p className="text-lg text-zinc-400">Everything you need to know about analyzing, visualizing, and querying GitHub repositories with Codyn.</p>
            </div>
