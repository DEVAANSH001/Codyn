...
export const metadata: Metadata = createSeoMetadata({
  ...
  description: "How Codyn handles account data, usage analytics, authentication, and scan-related information.",
  canonical: "/privacy",
  ogImage: buildOgImageUrl("marketing", { variant: "privacy" }),
  ogTitle: "Privacy Policy",
  ogDescription: "How Codyn handles account data, usage analytics, authentication, and scan-related information.",
});
    ...
    <main className="min-h-screen bg-black text-white px-6 py-20">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="text-zinc-300 leading-relaxed mb-4">
          Codyn respects your privacy. We only collect data required to operate the product and improve reliability.
        </p>
