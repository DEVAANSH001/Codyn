...
export const metadata: Metadata = createSeoMetadata({
  ...
  description:
    "Use Codyn as an AI code review tool to review implementation quality with full repository context, clearer prioritization, and faster feedback loops.",
...
const faqItems = [
  {
    ...
    answer:
      "Codyn incorporates repository context so review comments account for architecture and dependency impact beyond the immediate diff.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. CI checks enforce baseline quality, while Codyn strengthens contextual interpretation during review.",
  },
  {
...
const softwareSchema = buildSoftwareApplicationStructuredData({
  name: "Codyn AI Code Review Tool",
  description:
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <header className="mb-10">
          ...
          <p className="text-zinc-300 text-lg leading-relaxed mb-4">
            Codyn helps engineering teams review code with repository-level context, making it easier
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 md:p-8 mb-10">
          ...
          <p className="text-zinc-300 leading-relaxed mb-4">
            Codyn starts with review intent, then evaluates changes with broader repository context.
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 md:p-8 mb-10">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/static-analysis-vs-codyn" className="px-4 py-2 rounded-lg border border-zinc-700 hover:bg-zinc-900 transition-colors">
