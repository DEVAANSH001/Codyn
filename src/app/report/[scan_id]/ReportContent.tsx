...
const verificationConfig = {
    ...
    DETECTED: { label: "Detected", className: "text-blue-300 border-blue-500/30 bg-blue-500/10" },
} as const;
...
const traceTypeConfig = {
    source: { label: "Trace Source", className: "border-blue-500/25 bg-blue-500/10 text-blue-100" },
...
export function ReportContent({
    ...
    const verifiedBadgeSnippet = useMemo(
        () =>
            `[![Codyn Verified Security Scan](https://img.shields.io/badge/Codyn-Verified%20Security%20Scan-22c55e?style=for-the-badge)](${shareableUrl})`,
        [shareableUrl]
    );
    const verifiedReportSnippet = useMemo(
        () =>
            `Codyn verified security report for ${scan.owner}/${scan.repo}: ${verifiedSeverityTotals.critical} critical, ${verifiedSeverityTotals.high} high, ${verifiedSeverityTotals.medium} medium, ${verifiedSeverityTotals.low} low. Security Health Score ${healthScore.score}/100 (${healthScore.grade}). ${shareableUrl}`,
        [
            healthScore.grade,
            healthScore.score,
            scan.owner,
    ...
    return (
        <div className="min-h-screen bg-black text-white p-4 md:p-8 selection:bg-blue-500/30">
            <div className="max-w-4xl mx-auto space-y-8">
                <div data-testid="report-actions-navbar" className="print:hidden">
                    <div className="rounded-2xl border border-white/10 bg-zinc-950/80 p-4 shadow-lg md:hidden">
                        <div className="flex items-center justify-between gap-3">
                            <span className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-blue-300">
                        ...
                        {isMobileActionsOpen && (
                            <div id="report-actions-mobile-menu" className="mt-3 flex flex-col gap-2">
                                {isOutdated ? (
                                    <Link
                                        href={repoChatHref}
                                        className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-blue-500"
                                    >
                                    ...
                                    <>
                                        ...
                                        <button
                                            ...
                                            className="inline-flex items-center justify-center gap-2 rounded-lg border border-blue-500/40 bg-blue-600/15 px-3.5 py-2 text-sm font-medium text-blue-200 transition-all hover:bg-blue-600/25"
                                        >
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    {isSharedView && (
                                        <span className="inline-flex items-center rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-blue-300">
                                            Shared Link
                                        </span>
                                    )}
                                </div>
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                        ...
                        <div className="print:hidden flex flex-col gap-3 lg:items-end">
                            <Link
                                ...
                                className="inline-flex items-center justify-center gap-2 rounded-lg border border-blue-500/50 bg-blue-600 px-3.5 py-2 text-sm font-medium text-white transition-all hover:bg-blue-500"
                            >
                                <Shield className="w-4 h-4" />
                                Repository Profile
                            </Link>
                ...
                <div className="rounded-2xl border border-white/10 bg-zinc-900/70 p-6">
                    ...
                    <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-4">
                        <div className="rounded-xl border border-blue-500/20 bg-blue-500/10 p-4 sm:col-span-2">
                            <p className="text-xs uppercase tracking-wider text-blue-300">Score</p>
                            ...
                            <div className="space-y-3">
                                {topFixesByFingerprint.map((view, rank) => (
                                    <div key={`${view.fingerprint}:${rank}`} className="flex flex-col gap-3 rounded-xl border border-white/10 bg-zinc-950/50 p-4">
                                        <div className="space-y-2">
                                            <div className="flex flex-wrap items-center gap-2">
                                                <span className="rounded-full border border-blue-500/20 bg-blue-500/10 px-2.5 py-1 text-xs font-semibold text-blue-300">
                                                    Priority #{rank + 1}
                                                </span>
                                    ...
                                    <div className="space-y-6 p-5">
                                        ...
                                        <div className="flex flex-col space-y-2">
                                            ...
                                            <div className="rounded-lg border border-blue-500/10 bg-blue-500/5 p-4">
                                                <p className="text-sm text-blue-200">{view.finding.recommendation}</p>
                                            </div>
                                        </div>
                ...
                <div className="no-export pt-8 text-center text-sm text-zinc-600">
                    <p>Generated by <a href={baseUrl} className="font-semibold text-zinc-500 transition-colors hover:text-blue-400">Codyn</a> — The AI developer sidekick.</p>
                </div>
            </div>
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl border border-white/10 bg-zinc-900 px-4 py-3 text-sm text-zinc-100 placeholder:text-zinc-500 focus:border-blue-500/50 focus:outline-none"
                                    autoFocus
                                />
                                <p className="text-xs text-zinc-500">
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className="w-full rounded-xl border border-white/10 bg-zinc-900 px-4 py-3 text-sm text-zinc-100 focus:border-blue-500/50 focus:outline-none"
                                >
