                ...
                >
                    ...
                    <div
                        style={{
                            ...
                            width: '200%',
                            height: '200%',
                            backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(147, 51, 234, 0.15), transparent 50%)', // cyan-600
                            pointerEvents: 'none',
                        }}
                    />
                    ...
                    >
                        ...
                        <div
                            style={{
                                ...
                                backgroundImage: 'linear-gradient(to bottom, #ffffff, #e9d5ff)', // white to cyan-100
                                backgroundClip: 'text',
                                color: 'transparent',
                            }}
                        >
                        ...
                        >
                            ...
                            <span style={{ color: '#42a5ff', fontWeight: 600 }}>Codyn AI</span>
                        </div>
                    </div>
                </div>
            ),
