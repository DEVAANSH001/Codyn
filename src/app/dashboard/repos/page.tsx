        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-cyan-500/30 bg-zinc-900 shrink-0">
                        {session.user.image ? (
                ...
                {!loading && !hasPrivateAccess && (
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-xl transition-all shadow-lg shadow-cyan-500/20 text-sm font-medium"
                    >
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full bg-zinc-900 border border-white/10 rounded-xl pl-12 pr-4 py-4 text-white placeholder-zinc-500 focus:outline-none focus:border-cyan-500/50 transition-colors shadow-lg"
                />
            </div>
                        ...
                        >
                            <div>
                                <div className="flex items-start justify-between mb-3">
                                    <h3 className="font-semibold text-lg text-white group-hover:text-cyan-400 transition-colors line-clamp-1 flex-1 pr-4">
                                        {repo.name}
                                    </h3>
                                    {repo.private ? (
                            ...
                            <div className="flex items-center justify-between border-t border-white/5 pt-4 mt-auto">
                                ...
                                <Link
                                    ...
                                    className="flex items-center gap-1.5 text-xs font-medium text-white bg-white/5 hover:bg-white/10 px-3 py-1.5 rounded-lg transition-colors group-hover:bg-cyan-600 group-hover:text-white"
                                >
