...
export const metadata: Metadata = createSeoMetadata({
  ...
  description:
    "Compare Codyn workflows for repository analysis, AI code review, and security scanning across context depth and actionability.",
  canonical: "/compare",
  ogImage: buildOgImageUrl("marketing", { variant: "compare" }),
  ogTitle: "Compare Codyn Workflows and Alternatives",
...
const comparisonPages = [
  ...
  },
  {
    ...
    href: "/codyn-vs-sonarqube",
    summary: "Understand where SonarQube and Codyn can complement each other.",
  },
  {
    title: "Codyn vs Snyk",
    href: "/codyn-vs-snyk",
