...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const defaultRoutes: MetadataRoute.Sitemap = [
        ...
        {
            url: `${baseUrl}/static-analysis-vs-codyn`,
            lastModified: getFileModDate("src/app/static-analysis-vs-codyn/page.tsx"),
            changeFrequency: "weekly",
            priority: 0.75,
        },
        {
            url: `${baseUrl}/codyn-vs-sonarqube`,
            lastModified: getFileModDate("src/app/codyn-vs-sonarqube/page.tsx"),
            changeFrequency: "weekly",
            priority: 0.75,
        },
        {
            url: `${baseUrl}/codyn-vs-snyk`,
            lastModified: getFileModDate("src/app/codyn-vs-snyk/page.tsx"),
            changeFrequency: "weekly",
            priority: 0.75,
        },
        ...blogPosts.map((post) => ({
