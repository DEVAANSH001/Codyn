...
export const metadata: Metadata = createSeoMetadata({
  ...
  description:
    "Run full-context GitHub repository analysis with Codyn to map architecture, understand implementation behavior, and prioritize repository risk.",
...
const faqItems = [
  {
    question: "What is GitHub repository analysis in Codyn?",
    answer:
...
const softwareSchema = buildSoftwareApplicationStructuredData({
  name: "Codyn GitHub Repository Analysis",
  description:
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <header className="mb-10">
          ...
          <p className="text-zinc-300 text-lg leading-relaxed mb-4">
            Codyn helps teams evaluate unfamiliar repositories by mapping architecture, tracing
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 md:p-8 mb-10">
          ...
          <p className="text-zinc-300 leading-relaxed mb-4">
            Codyn does more than summarize files. It highlights how modules connect, where critical
