...
import Footer from "@/components/CodynFooter";
...
export const metadata: Metadata = createSeoMetadata({
  title: "About",
  description:
    "Codyn is an open-source, browser-first platform for GitHub repository analysis, architecture understanding, code review, and security scanning.",
  canonical: "/about",
  ogImage: buildOgImageUrl("marketing", { variant: "about" }),
  ogTitle: "About Codyn",
  ogDescription:
    "Learn how Codyn delivers full-context repository analysis, AI code review, and security scanning.",
  keywords: [
    "Codyn",
    "About Codyn",
    "Agentic CAG",
...
const workflowSteps = [
  ...
  },
  {
    ...
    description: "Codyn selects full, relevant files to retain true architecture and logic flow.",
  },
  {
...
const galleryItems = [
  ...
  },
  {
    ...
    description: "Everything Codyn can do in one view.",
    image: "/og.png",
  },
];
...
const aboutFaqItems = [
  ...
  {
    question: "Who built Codyn?",
    answer:
      "Codyn is maintained in the Codyn repository and incorporates the MIT-licensed RepoMind foundation with full upstream attribution.",
  },
];
...
export default function AboutPage() {
  ...
  const projectSchema = {
    ...
    name: "Codyn",
    description: "Open-source repository intelligence for architecture, code review, and security analysis.",
    codeRepository: "https://github.com/DEVAANSH001/Codyn",
  ...
  const aboutSchema = {
    ...
    mainEntity: {
      ...
      creator: { "@type": "Organization", name: "Codyn" },
    },
  };
  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-x-hidden relative">
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[80vw] max-w-[520px] h-[80vw] max-h-[520px] bg-cyan-600/30 rounded-full blur-[120px]" />
      </div>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-zinc-300 leading-relaxed mb-6">
              Codyn is an open-source, browser-first platform for understanding GitHub repositories and developer profiles through Agentic Context-Augmented Generation (CAG). It lets developers build full mental models without cloning, running, or spelunking through endless files.
            </p>
            <p className="text-zinc-400 leading-relaxed mb-8">
              The mission is simple: stop reading code in fragments and start understanding it end-to-end. Codyn connects architecture, dependencies, and behavior into answers you can act on quickly.
            </p>
            <p className="text-sm text-zinc-500 mb-8">
              Codyn integrates the MIT-licensed RepoMind foundation and preserves its upstream attribution.
            </p>
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-b from-blue-500/20 to-cyan-500/5 blur-2xl rounded-3xl" />
        ...
        <div className="max-w-6xl mx-auto">
          <div>
            ...
            <p className="text-zinc-400 text-lg mb-8">
              From architecture clarity to security insights, Codyn turns entire repositories into an understandable, actionable narrative.
            </p>
      ...
      <section className="relative z-10 px-6 py-20 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">How Codyn Works</h2>
            <p className="text-zinc-400 text-lg">
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-6 items-center">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Codyn connects entrypoints, services, and dependencies so you can reason about behavior end-to-end, not just isolated files.
              </p>
      ...
      <section className="relative z-10 px-6 py-20 bg-zinc-950 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 text-lg">
              Screens and flows from Codyn in action.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[0.9fr_1.1fr] gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-zinc-400 text-lg mb-6">
              Standard &quot;chat with your code&quot; tools often rely on RAG-style chunking. Codyn uses Agentic CAG to pull complete, relevant files so the model sees the real architecture and logic flow.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
          <div>
            ...
            <p className="text-zinc-300 text-lg leading-relaxed mb-4">
              Codyn brings a distinct product experience and visual system to a complete repository-intelligence stack: full-context chat, architecture exploration, code review, security scanning, reports, and team history.
            </p>
            <p className="text-zinc-400 leading-relaxed mb-6">
              Its application foundation comes from the MIT-licensed RepoMind project. That upstream work remains credited in the source tree while Codyn owns the product identity, integration, and ongoing evolution.
            </p>
            <div className="flex flex-wrap gap-3">
              <a
                href="https://github.com/DEVAANSH001/Codyn"
          ...
          <div className="rounded-3xl border border-zinc-800 bg-zinc-900/40 p-6">
            ...
            <div className="space-y-4 text-sm text-zinc-400">
              <p>
                Codyn is live and free to use for public repository analysis, with fair-use limits on heavy tool calls to keep the platform fast and accessible.
              </p>
              <p>
            ...
            <div className="mt-6 rounded-2xl border border-zinc-800 bg-zinc-950 p-4 text-xs text-zinc-500">
              <span className="text-zinc-300 font-semibold">Open source repo:</span> github.com/DEVAANSH001/Codyn
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 px-6 py-20 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-zinc-400 text-lg">Quick answers from the Codyn workflow.</p>
          </div>
      ...
      <section className="relative z-10 px-6 py-20 bg-zinc-950 border-t border-white/5">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">
            Try Codyn on your next repository
          </h2>
          <p className="text-zinc-400 text-lg mb-8">
      ...
      <Footer />
      <JsonLdScript data={projectSchema} />
