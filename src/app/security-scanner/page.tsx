...
export const metadata: Metadata = createSeoMetadata({
  ...
  description:
    "Scan GitHub repositories for actionable security risks with Codyn and prioritize remediation using architecture-aware context.",
...
const faqItems = [
  {
    question: "What does Codyn security scanning focus on?",
    answer:
      "Codyn focuses on practical risk prioritization by pairing findings with architecture and implementation context.",
  },
  {
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <header className="mb-10">
          ...
          <p className="text-zinc-300 text-lg leading-relaxed mb-4">
            Codyn helps teams identify and prioritize repository security risks using architecture-aware
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 md:p-8 mb-10">
          ...
          <p className="text-zinc-300 leading-relaxed mb-4">
            ...
            Codyn improves this by connecting findings to module criticality and implementation behavior.
          </p>
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 md:p-8 mb-10">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/codyn-vs-snyk" className="px-4 py-2 rounded-lg border border-zinc-700 hover:bg-zinc-900 transition-colors">
              Codyn vs Snyk
            </Link>
          </div>
        </section>
