...
export const metadata: Metadata = createSeoMetadata({
  ...
  description:
    "Explore Codyn solutions for GitHub repository analysis, AI code review, and security scanning with context-aware workflows and action-ready outputs.",
  canonical: "/solutions",
  keywords: [
  ...
  ogTitle: "Codyn Solutions for Repository Analysis and Security",
  ogDescription:
...
const compareLinks = [
  { name: "Static Analysis vs Codyn", href: "/static-analysis-vs-codyn" },
  { name: "Codyn vs SonarQube", href: "/codyn-vs-sonarqube" },
  { name: "Codyn vs Snyk", href: "/codyn-vs-snyk" },
];

const faqItems = [
  {
    question: "What is the best Codyn solution to start with?",
    answer:
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mb-12">
          ...
          <p className="text-zinc-300 text-lg leading-relaxed max-w-4xl mb-5">
            Codyn gives engineering teams a practical way to move from repository uncertainty to
        ...
        <section className="mb-12">
          <SeoVisual
            variant="hero-flow"
            ariaLabel="Codyn solutions workflow from repository input to analysis and action"
            sizeMode="wide"
            animate
            priority="high"
          />
