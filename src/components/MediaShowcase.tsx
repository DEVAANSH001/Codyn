...
const mediaItems = [
    {
        ...
        description: "How Codyn solves the 80% of developer time wasted on building context manually.",
        type: "Article",
        platform: "Medium",
    ...
    {
        title: "Official Demo: Codyn Workflow",
            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-16">
                    ...
                    <p className="text-zinc-400 text-lg max-w-2xl">
                        Explore the stories and technical deep dives behind Codyn&apos;s creation.
                    </p>
                </div>
