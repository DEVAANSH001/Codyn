...
export function ChatInput({
    ...
    return (
        <div className="relative group/input max-w-4xl mx-auto flex flex-col gap-2">
            ...
            >
                {isDragging && (
                    <div className="absolute inset-0 z-50 rounded-2xl flex items-center justify-center bg-cyan-900/50 backdrop-blur-sm border-2 border-dashed border-cyan-500/50">
                        <span className="text-cyan-200 font-bold tracking-tight">Drop files to add context</span>
                    </div>
                )}
                                    ...
                                    return (
                                        <motion.span
                                            ...
                                            className={cn(
                                                ...
                                                isFolder ? "bg-orange-500/10 border-orange-500/20 text-orange-300" : "bg-cyan-500/10 border-cyan-500/20 text-cyan-300"
                                            )}
                                        >
                                            ...
                                            <button 
                                                ...
                                                className={cn("rounded-full p-0.5 transition-colors shrink-0 outline-none", isFolder ? "hover:bg-orange-500/20" : "hover:bg-cyan-500/20")}
                                            >
                                                <X className="w-3 h-3" />
                                            </button>
                                        </motion.span>
