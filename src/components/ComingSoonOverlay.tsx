        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="relative z-10">
                    <div className="w-20 h-20 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-3xl flex items-center justify-center mx-auto mb-6 border border-white/5 ring-1 ring-white/10 group-hover:ring-cyan-500/30 transition-all duration-500">
                        <Lock className="w-10 h-10 text-cyan-400 group-hover:scale-110 transition-transform duration-500" />
                    </div>
