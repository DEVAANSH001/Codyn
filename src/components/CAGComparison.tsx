            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    ...
                    <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
                        Codyn uses <strong>Agentic Context Augmented Generation (Agentic CAG)</strong>. We don&apos;t just retrieve fragments; we understand the whole picture.
                    </p>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    {/* Codyn Agentic CAG Card */}
                    <div className="bg-gradient-to-b from-blue-900/20 to-cyan-900/20 border border-blue-500/30 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden hover:border-blue-500/50 transition-colors cursor-default flex flex-col shadow-[0_0_30px_rgba(59,130,246,0.1)]">
                        ...
                        <div className="flex items-center gap-3 mb-6 relative z-10">
                            ...
                            <h3 className="text-2xl font-semibold text-white">Codyn (Agentic CAG)</h3>
                        </div>
                            ...
                            {[...Array(5)].map((_, i) => {
                                ...
                                return (
                                    <Fragment key={`node-group-${i}`}>
                                        ...
                                        <motion.div
                                            key={`node-${i}`}
                                            className="absolute w-8 h-8 bg-cyan-900/40 border border-cyan-500/50 rounded flex items-center justify-center text-[8px] text-cyan-300 font-mono"
