...
const socialLinks = [
    { name: "GitHub", icon: Github, href: "https://github.com/DEVAANSH001/Codyn" },
...
export const footerLinks = {
    ...
    media: [
        { name: "GitHub Repository", href: "https://github.com/DEVAANSH001/Codyn" },
    ]
};
...
export default function Footer() {
    ...
    const contactUrl = "https://github.com/DEVAANSH001/Codyn/issues/new";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 pb-16">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <Link href="/" className="flex items-center gap-3 group">
                            <div>
                                <h2 className="text-xl font-bold text-white tracking-tight group-hover:text-cyan-400 transition-colors">Codyn</h2>
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
                        <p className="text-zinc-600 text-[11px] font-medium tracking-tight">
                            © {new Date().getFullYear()} CODYN. BUILT BY DEVELOPERS FOR DEVELOPERS.
                        </p>
