        ...
        <div className="mb-2 not-prose select-none">
            ...
            >
                <div className="flex items-center gap-2 shrink-0">
                    <span className="text-xs font-semibold uppercase tracking-widest text-cyan-400/80 group-hover:text-cyan-400 transition-colors">
            ...
            <AnimatePresence>
                {isExpanded && hasRealThoughts && (
                    ...
                    >
                        <div className="mt-2 space-y-3 pl-3 border-l border-cyan-500/20">
