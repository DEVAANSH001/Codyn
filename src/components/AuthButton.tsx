    ...
    if (session) {
        return (
            <div className="relative">
                ...
                >
                    <div className="w-9 h-9 md:w-10 md:h-10 rounded-full overflow-hidden border border-white/10 group-hover:border-cyan-500/50 transition-colors">
                        {session.user?.image ? (
                            <Image
                        ...
                        <>
                            ...
                            >
                                <Link
                                    ...
                                    onClick={() => setIsMenuOpen(false)}
                                >
                                    <LayoutDashboard className="w-4 h-4 group-hover:text-cyan-400" />
                                    <span>Dashboard</span>
                                </Link>
