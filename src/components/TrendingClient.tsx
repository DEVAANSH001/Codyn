...
import Footer from "./CodynFooter";
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
                            Trending <span className="bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent">
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between mt-auto">
                                ...
                                <Link 
                                    ...
                                    aria-label={`Analyze ${repo.owner}/${repo.repo} with Codyn`}
