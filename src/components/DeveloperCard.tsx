...
export function DeveloperCard({ username, name: initialName, avatar: initialAvatar, bio: initialBio, location: initialLocation, blog: initialBlog }: DeveloperCardProps) {
    ...
    return (
        ...
        >
            <div className="relative bg-zinc-900 border border-white/10 rounded-xl p-5 hover:border-cyan-600/50 transition-all duration-300">
                {/* Gradient glow on hover */}
                <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-xl blur opacity-0 group-hover:opacity-20 transition duration-500" />
                ...
                <div className="relative flex gap-4">
                    ...
                    <div className="relative w-16 h-16 shrink-0">
                        <Image
                            ...
                            unoptimized
                        />
                        <div className="hidden w-16 h-16 rounded-full bg-gradient-to-br from-cyan-600 to-blue-600 flex items-center justify-center overflow-hidden">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-3 text-xs text-zinc-500 mb-4">
                            ...
                            {profile.blog && (
                                <a
                                    ...
                                    className="flex items-center gap-1 hover:text-cyan-400 transition-colors truncate max-w-[200px]"
                                >
                        ...
                        <div className="flex gap-2">
                            <Link
                                ...
                                className="flex-1 px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-medium rounded-lg transition-colors text-center"
                            >
                                View Profile
                            </Link>
                            <a
