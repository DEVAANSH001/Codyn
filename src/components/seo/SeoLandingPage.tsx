              ...
              <table className="w-full min-w-[760px]">
                <thead className="bg-zinc-950">
                  <tr>
                    ...
                    <th className="text-left px-4 py-3 text-cyan-200 font-semibold">{page.comparisonTable.codynLabel}</th>
                ...
                <tbody>
                  {page.comparisonTable.rows.map((row) => (
                    <tr key={`${page.slug}-${row.criteria}`} className="border-t border-zinc-800">
                      ...
                      <td className="px-4 py-4 text-zinc-300 align-top">{row.codyn}</td>
