    ...
    return typeof document !== 'undefined' ? createPortal(
        <AnimatePresence>
            <div className="fixed inset-0 z-[1000] flex items-center justify-center p-2 md:p-4">
                ...
                >
                    {/* Header */}
                    <div className="flex items-center justify-between p-4 md:p-6 border-b border-white/10 bg-gradient-to-r from-cyan-600/10 to-blue-600/10">
                        <div className="flex items-center gap-3">
                            <div className="p-1.5 md:p-2 bg-cyan-600 rounded-lg">
                            ...
                            {versions.map((version, vIndex) => (
                                <div key={version.version} className="relative">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        {version.isNew && (
                                            <span className="px-2 py-0.5 text-[10px] font-bold tracking-wider bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 rounded-full">
                                                LATEST
                                            </span>
                                        )}
                                    </div>
