...
export function ChatInterface({ repoContext, onToggleSidebar, initialPrompt }: ChatInterfaceProps) {
    ...
    const activeRunKey = useMemo(() => `codyn:chatRun:repo:${repoContext.owner}:${repoContext.repo}`, [repoContext.owner, repoContext.repo]);
                    ...
                    <div className="flex items-center gap-3 min-w-0 shrink">
                        ...
                        <div className="flex items-center gap-2 min-w-0 ml-2">
                            ...
                            <Link
                                ...
                                className="hidden lg:flex items-center text-[10px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-md bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 hover:text-cyan-300 transition-all border border-cyan-500/20"
                            >
                                Profile
                            </Link>
                        </div>
                        ...
                        return (
                            ...
                            >
                                <div className={cn(
                                    ...
                                    msg.role === "model"
                                        ? "bg-zinc-950 ring-2 ring-cyan-500/60"
                                            ...
                                            {msg.scanId && (
                                                <div className="mt-4 pt-4 border-t border-white/10 flex items-center gap-3">
                                                    <Link
                                                        ...
                                                        target="_blank"
                                                        className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-colors shadow-sm"
                                                    >
                                                        <Shield className="w-3.5 h-3.5" />
                                                        View Full Report
                                                    </Link>
                ...
                {referenceText && (
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 bg-zinc-900 border border-white/10 rounded-lg px-3 py-2 text-xs text-zinc-300">
                            <span className="text-zinc-400">Ask Codyn AI</span>
