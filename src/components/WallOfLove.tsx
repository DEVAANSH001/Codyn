...
const testimonials = [
    {
        ...
        content: "Codyn completely changed how I onboard into legacy codebases. What used to take 2 weeks of blindly reading code now takes me 30 minutes of chatting.",
    ...
    },
    {
        ...
        content: "I use Codyn's deep analysis to instantly scan for vulnerable code patterns across hundreds of repos. It's shockingly accurate.",
    ...
    },
    {
        ...
        content: "Tired of tracking down where that one random React context is defined? Codyn just tells you instantly and shows you exactly how it's wired across your entire application architecture.",
        ...
        <section className="py-24 px-4 relative z-10 max-w-7xl mx-auto w-full">
            <div className="text-center mb-16">
                ...
                <p className="text-zinc-400 text-lg">
                    See what engineers are saying about Codyn.
                </p>
            </div>
