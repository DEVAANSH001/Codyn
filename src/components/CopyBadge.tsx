...
export function CopyBadge({ owner, repo }: CopyBadgeProps) {
    ...
    const markdownSnippet = `[![Analyzed by Codyn](https://img.shields.io/badge/Analyzed%20by-Codyn-4F46E5?style=for-the-badge)](${baseUrl}/repo/${owner}/${repo})`;
    ...
    return (
        <div className="flex flex-col gap-4 p-6 bg-zinc-900/40 border border-zinc-800/80 rounded-xl backdrop-blur-md shadow-lg w-full">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-zinc-400 mt-0.5">Showcase Codyn&apos;s analysis directly in your repository&apos;s README.</p>
                    </div>
                </div>
                <button
                    onClick={handleCopy}
            ...
            <div className="relative group mt-2">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-lg blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="flex items-center gap-4 mt-1 bg-black/20 p-3 rounded-lg border border-white/5">
                ...
                <a href={`${baseUrl}/repo/${owner}/${repo}`} target="_blank" rel="noopener noreferrer" className="block transform hover:scale-105 transition-transform drop-shadow-[0_0_12px_rgba(79,70,229,0.2)] hover:drop-shadow-[0_0_16px_rgba(79,70,229,0.4)]">
                    <Image
                        src="https://img.shields.io/badge/Analyzed%20by-Codyn-4F46E5?style=for-the-badge"
                        alt="Analyzed by Codyn"
                        width={154}
                        height={28}
                        className="h-7"
                        unoptimized
