...
const {
    ...
    buildCodynPromptMock,
    buildCodynVisualPromptMock,
    ...
    buildCodynPromptMock: vi.fn(),
    buildCodynVisualPromptMock: vi.fn(),
...
vi.mock("@/lib/prompt-builder", () => ({
    buildCodynPrompt: buildCodynPromptMock,
    buildCodynVisualPrompt: buildCodynVisualPromptMock,
...
describe("answerWithContextStream", () => {
    beforeEach(() => {
        ...
        buildCodynPromptMock.mockReset();
        buildCodynVisualPromptMock.mockReset();
        ...
        buildCodynPromptMock.mockReturnValue("prompt");
        buildCodynVisualPromptMock.mockReturnValue("visual-prompt");
    ...
    it("uses visual-only prompt builder when query has visual intent", async () => {
        ...
        expect(buildCodynVisualPromptMock).toHaveBeenCalledTimes(1);
        expect(buildCodynPromptMock).not.toHaveBeenCalled();
        expect(buildCodynVisualPromptMock).toHaveBeenCalledWith(
